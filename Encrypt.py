...
def encrypt(text,s): #define the function encrypt with the text to encrypt and shift desired
    ...
    for i in range(len(text)): #establishes the loop as long as i is within the range of the length of the text
        ...
        if (char.isupper()): #if the character is upper case
            ...
            #Then the shift length is added to it and if it is upper case 65 is removed. The remainder of dividing by 26 and add 65 to get the new uppercase location for the letter.
            ...
            #Then the shift length is added to it and if it is lower case 65 is removed. The remainder of dividing by 26 and add 65 to get the new lowercase location for the letter
...
#cipher =  input('Please input cipher to brute force decrypt ') #to be used to brute force inputed cipher
